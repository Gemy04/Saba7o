<template>
  ...
  <div class="quiz-game">
    <div class="quiz-game__header">
      <h1 class="quiz-game__title">Saba7o Ta7dy Demo</h1>
    ...
    <div class="quiz-game__body">
      ...
      <div class="quiz-game__answers">
        <div
          class="quiz-game__answer"
          v-for="answer in answers"
          :key="answer"
        >
          <!-- if correct -->
          <button
            class="quiz-game__answer-button"
            :class="{
  ...
  data() {
    return {
      questions: [
        {
          id: 1,
          question: 'ماهي جنسية اللاعب السابق باتريك فييرا ',
